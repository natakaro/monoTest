...
namespace Game1.Input
{
    ...
    public class InputAction
    {
        ...
        private delegate bool MousePress(MouseButtons mouseButton);
        //private delegate bool MouseLeftPress();
        //private delegate bool MouseRightPress();
        //private delegate bool MouseMiddlePress();
        //private delegate bool MouseScrollUp();
        //private delegate bool MouseScrollDown();
        ...
        public InputAction(Keys[] keys, MouseButtons[] mouseButtons, bool newPressOnly)
        {
        ...
        public bool Evaluate(InputState state)
        {
            ...
            KeyPress keyTest;
            MousePress mouseTest;
            if (newPressOnly)
            {
                keyTest = state.IsNewKeyPress;
                mouseTest = state.IsNewMouseClick;
            }
            else
            {
