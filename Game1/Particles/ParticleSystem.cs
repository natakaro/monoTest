...
namespace Game1.Particles
{
    ...
    public abstract class ParticleSystem
    {
        ...
        EffectParameter effectFarClipParameter;
        EffectParameter effectDepthTextureParameter;
        ...
        void LoadParticleEffect()
        {
            ...
            effectFarClipParameter = parameters["FarClip"];
            effectDepthTextureParameter = parameters["Depth"];
        ...
        /// </summary>
        public void SetCamera(Matrix view, Matrix projection, float farClip, RenderTarget2D depthTarget)
        {
            effectViewParameter.SetValue(view);
            effectProjectionParameter.SetValue(projection);
            effectFarClipParameter.SetValue(farClip);
            effectDepthTextureParameter.SetValue(depthTarget);
        }
